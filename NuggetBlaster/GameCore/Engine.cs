namespace NuggetBlaster.GameCore
{
  ...
  class Engine
  {
    ...
    // Provide default gameArea used for calculating movement, collision, etc. scaling to display size only happens on draw
    public const int GameAreaWidth = 960;
    public const int GameAreaHeight = 509;
